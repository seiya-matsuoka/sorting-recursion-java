...
import io.github.seiya_matsuoka.sortingrecursion.algorithms.SelectionSortBasics;
import java.util.Arrays;

/** 選択ソート実行用 runner */
public class SelectionSortRunner implements TopicRunner {
  ...
  public void run(RunnerOptions options) {
    ...
    // 学習対象の本体処理を呼び出す部分
    SelectionSortBasics.SortResult result = SelectionSortBasics.sort(input, options.trace());
