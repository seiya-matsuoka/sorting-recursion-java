...
import io.github.seiya_matsuoka.sortingrecursion.algorithms.HeapSortBasics;
import java.util.Arrays;

/** ヒープソート実行用 runner */
public class HeapSortRunner implements TopicRunner {
  ...
  public void run(RunnerOptions options) {
    ...
    // 学習対象の本体処理を呼び出す部分
    HeapSortBasics.SortResult result = HeapSortBasics.sort(input, options.trace());
   ...
   * 大きい入力を自動生成する。
   *
   * <p>基本ソート 3 種との違いが見えやすいよう、 逆順に近い並びを使う。
   */
