...
import io.github.seiya_matsuoka.sortingrecursion.algorithms.BubbleSortBasics;
import java.util.Arrays;

/** バブルソート実行用 runner */
public class BubbleSortRunner implements TopicRunner {
  ...
  public void run(RunnerOptions options) {
    ...
    // 学習対象の本体処理を呼び出す部分
    BubbleSortBasics.SortResult result = BubbleSortBasics.sort(input, options.trace());
